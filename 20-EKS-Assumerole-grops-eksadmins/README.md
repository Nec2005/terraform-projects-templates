...
# Describe Cluster
aws eks --region eu-west-2 describe-cluster --name exp-dev-eksdemo1 --query cluster.status
...
- Login to AWS Mgmt Console
  ...
  - **Password:** @EKSUser101
- Go to EKS Servie: https://console.aws.amazon.com/eks/home?region=eu-west-2#
```t
# Error
Error loading clusters
User: arn:aws:iam::180789647333:user/hr-dev-eksadmin1 is not authorized to perform: eks:ListClusters on resource: arn:aws:eks:eu-west-2:180789647333:cluster/*
```  
...
- Access EKS Cluster -> exp-dev-eksdemo1
  - Overview Tab
  - Workloads Tab
  - Configuration Tab  
