...
resource "helm_release" "efs_csi_driver" {
  ...
  set {
    ...
    value = "602401143452.dkr.ecr.eu-west-2.amazonaws.com/eks/aws-efs-csi-driver" # Changes based on Region - This is for eu-west-2 Additional Reference: https://docs.aws.amazon.com/eks/latest/userguide/add-ons-images.html
  }       
