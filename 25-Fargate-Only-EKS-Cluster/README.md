...
aws eks list-fargate-profiles --cluster=exp-dev-eksdemo1
```
...
# Access Application
http://fargate-profile-demo2.necatidevops.uk
http://fargate-profile-demo2.necatidevops.uk/app1/index.html
http://fargate-profile-demo2.necatidevops.uk/app2/index.html
```

## Step-13: Verify all the pods on EKS Cluster using AWS Mgmt Console
- Go to Services -> Elastic Kubernetes Service -> Clusters -> exp-dev-eksdemo1
- In **Resources** Tab
