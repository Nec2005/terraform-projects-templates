...
```yaml
    # TLS
    service.beta.kubernetes.io/aws-load-balancer-ssl-cert: arn:aws:acm:eu-west-2:180789647333:certificate/d86de939-8ffd-410f-adce-0ce1f5be6e0d
...
```yaml
    ...
    external-dns.alpha.kubernetes.io/hostname: nlbdns101.necatidevops.uk
```
...
nslookup nlbdns101.necatidevops.uk

# Access Application
# Test HTTP URL
http://nlbdns101.necatidevops.uk

# Test HTTPS URL
https://nlbdns101.necatidevops.uk
```
...
resource "kubernetes_service_v1" "myapp3_nlb_service" {
  metadata {
    ...
    annotations = {
      ...
      # External DNS - For creating a Record Set in Route53
      "external-dns.alpha.kubernetes.io/hostname" = "tfnlbdns101.necatidevops.uk"
    }        
  }
  spec {
    selector = {
